            ...
            <div class="card-body">
                <form id="timeForm" class="mb-4">
                    <div class="row g-3">
                        <!-- Sleep Time (seconds) -->
                        <div class="col-md-6">
                            <label for="sleep" class="form-label fw-bold">Sleep <span class="text-warning"
                        ...
                        <!-- Loop Count -->
                        <div class="col-md-6">
                            <label for="loop" class="form-label fw-bold">Loop</label>
                            <input type="number" class="form-control" id="loop" value="500" min="1">
                        </div>

                        <!-- IPs -->
                        <div class="col-md-3">
                            <label for="ips" class="form-label fw-bold">IPs</label>
                            <input type="number" class="form-control" id="ips" value="1" min="1">
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateSleepTime() {
                ...
                sleepNum.textContent = `{ Result Calculate Sleep: ${sleepTime} }`;
